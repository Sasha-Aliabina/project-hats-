...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal modal-center" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      ...
      (options.footer ?
      '    <div class="modal-footer modal-footer-summer">' + options.footer + '</div>' : ''
      ),
      '  </div>',
      '</div>'
    ].join(''));
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      image: {
        ...
        shapeNone: 'Форма: Нет',
        dragImageHere: 'Перетащите изображение',
      ...
      table: {
        table: 'Таблица',
        addRowAbove: 'Добавить строку выш',
      ...
      color: {
        recent: 'Выделить цветом',
        more: 'Настроить цвета',
      ...
      help: {
        ...
        'outdent': 'Уменьшить отступ блока',
        'indent': 'Увеличить отступ блока',
        'formatPara': 'Изменить формат блока на абзац (тег P)',
        'formatH1': 'Изменить формат блока на Заголовок 1',
        'formatH2': 'Изменить формат блока на Заголовок 2',
        'formatH3': 'Изменить формат блока на Заголовок 3',
        'formatH4': 'Изменить формат блока на Заголовок 4',
        'formatH5': 'Изменить формат блока на Заголовок 5',
        'formatH6': 'Изменить формат блока на Заголовок 6',
        'insertHorizontalRule': 'Вставить горизонтальную линию',
        'linkDialog.show': 'Показать ссылки'
      },
      history: {
        undo: 'Отменить',
        redo: 'Повторить'
      ...
      specialChar: {
        ...
        select: 'Выбрать специальный символ'
      }
    }
  });
  ...
  */
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group">' +
                   '<label>' + lang.link.textToDisplay + '</label> <br>' +
                   '<input class="note-link-text form-control" type="text" />' +
                 '</div>' +
                 '<div class="form-group">' +
                   '<label>' + lang.link.url + '</label><br>' +
      ...
      var footer = '<button href="#" class="bttn bttn-success note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                   '<label>' + lang.image.selectFromFiles + '</label> <br>' +
                 ...
                 '</div>';
      var footer = '<button href="#" class="bttn bttn-success note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group row-fluid">' +
          '<label>' + lang.video.url + ' <small class="text-muted">' + lang.video.providers + '</small></label><br>' +
          '<input class="note-video-url form-control span12" type="text" />' +
          '</div>';
      var footer = '<button href="#" class="bttn bttn-success note-video-btn disabled" disabled>' + lang.video.insert + '</button>';
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      fontNames: ['Adana', 'Merriweather', 'PT Sans'],

      fontSizes: ['16', '18', '19', '20', '22', '24', '28', '36', '42', '54', '64', '72'],
